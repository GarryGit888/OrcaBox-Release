...
| Windows x64 | Windows 10 或 Windows 11 | [CNB 下载 EXE（1.1.2）](https://cnb.cool/garrykai/orcabox-release/-/releases/download/v1.1.2/OrcaBox-1.1.2-Windows-x64.exe) |

本次 `1.1.2` macOS Apple Silicon 与 Windows x64 包均已完成构建和资源校验。Windows 包由 macOS 主机完成跨平台构建，未包含 Windows 系统分享原生插件。
...
OrcaBox-1.1.2-Windows-x64.exe
SHA-256: 0b469ba4c70e8b29e8ea7bc75c61ff2cf4cea6ff9839e7ae887a6e3db6a2522a
```
...
```powershell
Get-FileHash .\OrcaBox-1.1.2-Windows-x64.exe -Algorithm SHA256
```
